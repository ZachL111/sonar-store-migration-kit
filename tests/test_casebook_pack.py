"""Regression checks for the sonar-store-migration-kit casebook."""
...
from casebook.harness import assert_expected, sonar_store_migration_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_store_migration_kit_summary(), assert_expected())
